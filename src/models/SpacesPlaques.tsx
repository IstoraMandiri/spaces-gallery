...
export default function Model(props: ModelProps) {
  ...
  const { nodes, materials } = useLoader<GLTFResult>(
    GLTFLoader,
    "https://d27rt3a60hh1lx.cloudfront.net/models/SpacesPlaques1/SpacesPlaques1.glb",
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      >
        ...
        <group
          position={[-0.045408, 0.0025, -0.170328]}
          scale={[0.6, 0.6, 0.6]}
        >
          <mesh
        ...
        <group
          position={[0.124403, 0.0025, -0.122515]}
        ...
        <group
          position={[-0.120019, 0.0025, 0.127006]}
          rotation={[-Math.PI, Math.PI / 3, Math.PI]}
          scale={[0.6, 0.6, 0.6]}
        >
          <mesh
        ...
        <group
          position={[-0.167298, 0.0025, -0.051873]}
          rotation={[0, Math.PI / 3, 0]}
          scale={[0.6, 0.6, 0.6]}
        >
          <mesh
