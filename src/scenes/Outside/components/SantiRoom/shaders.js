...
void main() {
    ...
    float n = snoise( vec3( floor( uvx * res.x ), floor( uvy * res.y ), time ) * 100.0 );
...
void main()\t{
    ...
    float n = ( snoise_1( vec2( uv.x * 10.01, time * 0.1 ) ) + 1.0 ) * 0.5;
    
    if( uv.x < 0.005 ) k = smoothstep( 0.5, 0.5, ( 1.0 + snoise_1( vec2( uv.y * 0.10, time * 10.0 ) ) ) * 0.5 );
    else {
        float ttt[8];
...
void main() {
    ...
    float n = ( snoise_0( vec2( time * 0.01, 1.0 ) ) + 1.0 ) * 0.5;
    ...
    // left screen
    float l2 = 0.0;
    float n2 = ( snoise_0( vec2( 10.0, time * 0.01 ) ) + 1.0 ) * 0.5;
    if( n2 > 0.8 ) l2 = l.g * 1.0;

    // right screen
    float n3 = ( snoise_0( vec2( 100.0, time * 0.01) ) + 1.0 ) * 0.5;
...
void main() {
    ...
    float n = ( snoise_0( vec2( time * 10.0, 1.0 ) ) + 1.0 ) * 0.5;
...
void main() {
    ...
    float n = ( snoise_1( vec3( uvx * offset.x * 1000.0, uvy * offset.y * 1000.0, time ) ) + 1.0 ) * 0.5;
...
void main() {
    vec4 l = texture2D( lightTex, vUv );
    float n = ( snoise_1( vec2( time * 0.01, 1.0 ) ) + 1.0 ) * 0.5;
    ...
    // left screen
    float l2 = 0.0;
    float n2 = ( snoise_1( vec2( 10.0, time * 0.01 ) ) + 1.0 ) * 0.5;
    if( n2 > 0.8 ) l2 = l.g * 1.0;

    // right screen
    float n3 = ( snoise_1( vec2( 100.0, time * 0.01) ) + 1.0 ) * 0.5;
    float l3 = l.b * ( 0.2 + 0.8 * n3 );
